...
if __name__ == "__main__":
    ...
    #保存预测结果
    #df_long.to_excel('amazon_forecast_6_months.xlsx', index=False)

    # 保存预测结果到数据库
    df_long.to_sql("Amazon_forecast_6_months", con=engine, if_exists='replace', index=False)